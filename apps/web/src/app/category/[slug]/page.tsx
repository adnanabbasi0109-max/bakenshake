...
const demoCategoryData: Record<string, { name: string; banner: string; products: Array<{
  ...
  bakery: {
    ...
    products: [
      ...
      { _id: "9", name: "Butter Croissant", slug: "butter-croissant", shortDescription: "Freshly baked French butter croissant", images: [{ url: "https://images.unsplash.com/photo-1555507036-ab1f4038024a?w=600&q=80", alt: "Butter croissant", isPrimary: true }], variants: [{ _id: "v9", size: "Single", price: 79 }], dietaryTags: ["eggless", "veg"], ratings: { average: 4.5, count: 334 } },
      { _id: "10", name: "Honey Almond Tea Cake", slug: "honey-almond-tea-cake", shortDescription: "Moist honey cake with toasted almonds", images: [{ url: "https://images.unsplash.com/photo-1486427944544-d2c246c4df6e?w=600&q=80", alt: "Honey almond tea cake", isPrimary: true }], variants: [{ _id: "v10", size: "250g", price: 179 }], dietaryTags: ["eggless", "veg"], ratings: { average: 4.7, count: 156 } },
